<div>
	...
	<form wire:submit="save">
		...
		<div class="flex gap-4 mt-4">
			<div class="w-1/2">
				...
				<select wire:model.live="form.type"
					class="block w-full p-2 rounded-lg ring-0 bg-neutral-800 text-sm text-neutral-400" id="type" required>
			...
			<div class="w-1/2">
				...
				<select wire:model.live="form.gender"
					class="block w-full p-2 rounded-lg ring-0 bg-neutral-800 text-sm text-neutral-400" id="gender" required>
					<option>Selecciona una opción</option>
		...
		<button wire:loading.attr="disabled" type="submit"
			class="bg-neutral-50 px-6 py-4 rounded-lg w-full mt-8 text-neutral-900 text-xl font-semibold hover:bg-neutral-300 transition-all duration-200 shadow-sm shadow-neutral-50 relative">
